...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/ansimarkup-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=6101&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/ansimarkup-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `ansimarkup` can be installed with:

```
conda install ansimarkup
```

It is possible to list all of the versions of `ansimarkup` available on your platform with:
